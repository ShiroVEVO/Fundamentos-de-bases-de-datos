...
CREATE TABLE IF NOT EXISTS mydb.EstacioTieneBicicleta_has_Viaje (
  ...
  CONSTRAINT fk_EstacioTieneBicicleta_has_Viaje_EstacioTieneBicicleta1
    FOREIGN KEY (EstacioTieneBicicleta_fk_Estacion, EstacioTieneBicicleta_fk_Bicicleta)
    REFERENCES mydb.EstacioTieneBicicleta (fk_Estacion, fk_Bicicleta)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
